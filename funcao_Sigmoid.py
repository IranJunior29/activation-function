...
if __name__ == '__main__':
    ...
    modelo_fa3 = nn.Sequential(nn.Linear(input_size, hidden_sizes[0]),  # 784 x 128
                              nn.Sigmoid(),
    ...
    logps = modelo_fa3(images)

    # Perda
    loss = criterion(logps, labels)

    print('\nAntes do Backward Pass: \n', modelo_fa3[0].weight.grad)
    loss.backward()
    print('\nDepois do Backward Pass: \n', modelo_fa3[0].weight.grad)

    # Otimizador
    optimizer = optim.SGD(modelo_fa3.parameters(), lr=0.003, momentum=0.9)
    ...
    # Salvando o modelo
    torch.save(modelo_fa3, 'modelos/modelo_fa3.pt')
